...
const config = {
  ...
  OTP_EXPIRY: 300000,
  OWNER_NUMBER: process.env.OWNER_NUMBER || '94785505762',
  CHANNEL_LINK: 'https://whatsapp.com/channel/0029VbB8Sv72phHMubLEgH0F',
  BOT_NAME: '𝐑𝐀𝐕𝐈𝐘𝐀 𝐌𝐃 𝐕1',
  BOT_VERSION: '5.0.0V',
  OWNER_NAME: 'PAMUDINA RAVIHARA ',
  IMAGE_PATH: 'https://files.catbox.moe/oy7w48.jpg',
  BOT_FOOTER: '𝐑𝐀𝐕𝐈𝐘𝐀-𝐌𝐃 𝐕1',
  BUTTON_IMAGES: { ALIVE: 'https://i.ibb.co/gM997gRp/tourl-1765543281755.jpg' }
};
...
END:VCARD`
    ...
    try {
        ...
        const apiUrl = `https://movanest.zone.id/v2/ytsearch?query=lelena${encodeURIComponent(videoUrl)}`;
...
╭───❏ *𝐁𝐎𝐓 𝐒𝐓𝐀𝐓𝐔𝐒* ❏
│ 👽 *𝙱𝙾𝚃 𝙽𝙰𝙼𝙴*: ${title}
│ 👑 *𝙾𝚆𝙽𝙴𝚁*: ${config.OWNER_NAME || '𝙿𝙰𝙼𝚄𝙳𝙸𝙽𝙰 𝚁𝙰𝚅𝙸𝙷𝙰𝚁𝙰'}
│ 🏷️ *𝚅𝙴𝚁𝚂𝙸𝙾𝙽*: ${config.BOT_VERSION || '0.0001+'}
│ ☁️ *𝙿𝙻𝙰𝚃𝙵𝙾𝚁𝙼*: ${process.env.PLATFORM || 'Heroku'}
...
`.trim();
    ...
    const defaultImg = 'https://files.catbox.moe/oy7w48.jpg';
...
case 'mfdl': {
    try {
        ...
        const sanitized = (number || '').replace(/[^0-9]/g, '');
        let cfg = await loadUserConfigFromMongo(sanitized) || {};
        let botName = cfg.botName || 'RAVIYA MD MINI BOT AI';
...
case 'tagall': {
  try {
    ...
    let caption = `╭───❰ *♥️𝐆𝐑𝐎𝐔𝐏 𝐀𝐍𝐍𝐎𝐔𝐍𝐂𝐄𝐌𝐎𝐍𝐓♥️* ❱───╮\n`;
